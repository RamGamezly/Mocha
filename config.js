const config = {
  ...
  token: "NjQxNzk4OTU0MDk4MzYwMzQw.XkCg2A.f1_18Jsx_o5eUK2DEGxIQQzC4a4", //your token. You can obtain it at https://discordapp.com/developers/applications/
    ...
    },
    {
      ...
      check: message =>
        message.channel.type === "text"
          ? message.guild.owner === message.author.id
            ? true
            : false
          : false
    },
